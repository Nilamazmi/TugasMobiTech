package com.atmaluhur.law.latihan5;
...
public class makanan extends AppCompatActivity {
    ...
    private class AmbilDataMakanan extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "http://192.168.1.9/cafe/data_makanan.php";
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i <data_makanan.length(); i++) {
                        ...
                        //adding data_makanan.php to detail_makanan list
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(makanan.this, makananlist, R.layout.list_item_makanan, new String[]{"nama_menu", "harga", "keterangan"}, new int[]{R.id.txtnamamakanan, R.id.txtharga, R.id.txtketerangan});
